...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-2 text-gray-800">Tambah Data Sarana</h1>
            <p class="mb-4">Silahkan isi form dibawah untuk menambahkan data sarana.</p>
            ...
            <form action="<?= base_url('sarana/simpan'); ?>" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control <?= (validation_show_error('kode')) ? 'is-invalid' : ''; ?>" id="kode" name="kode" value="<?= old('kode'); ?>" autofocus>
