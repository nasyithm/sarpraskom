        ...
        <div class="container-fluid">
            ...
            <form action="<?= base_url('anggota/update'); ?>/<?= $anggota['id']; ?>" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control <?= (validation_show_error('nis')) ? 'is-invalid' : ''; ?>" id="nis" name="nis" value="<?= old('nis', $anggota['nis']); ?>" autofocus>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="kelas" name="kelas" value="<?= old('kelas', $anggota['kelas']); ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="nohp" class="col-sm-2 col-form-label">No HP</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="nohp" name="nohp" value="<?= old('nohp', $anggota['nohp']); ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-10">
